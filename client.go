...
func (mb *client) ReadCoils(slaveId uint8, address, quantity uint16) (results []byte, err error) {
...
func (mb *client) ReadDiscreteInputs(slaveId uint8, address, quantity uint16) (results []byte, err error) {
	if quantity < 1 || quantity > 2000 {
		err = fmt.Errorf("modbus: quantity '%v' must be between '%v' and '%v',", quantity, 1, 2000)
		return
	}
...
func (mb *client) ReadHoldingRegisters(slaveId uint8, address, quantity uint16) (results []byte, err error) {
...
func (mb *client) ReadInputRegisters(slaveId uint8, address, quantity uint16) (results []byte, err error) {
	if quantity < 1 || quantity > 125 {
		err = fmt.Errorf("modbus: quantity '%v' must be between '%v' and '%v',", quantity, 1, 125)
		return
	}
...
//	Output address        : 2 bytes
//	Output value          : 2 bytes
func (mb *client) WriteSingleCoil(slaveId uint8, address, value uint16) (results []byte, err error) {
...
//	Register address      : 2 bytes
//	Register value        : 2 bytes
func (mb *client) WriteSingleRegister(slaveId uint8, address, value uint16) (results []byte, err error) {
	request := ProtocolDataUnit{
...
//	Starting address      : 2 bytes
//	Quantity of outputs   : 2 bytes
func (mb *client) WriteMultipleCoils(slaveId uint8, address, quantity uint16, value []byte) (results []byte, err error) {
...
//	Starting address      : 2 bytes
//	Quantity of registers : 2 bytes
func (mb *client) WriteMultipleRegisters(slaveId uint8, address, quantity uint16, value []byte) (results []byte, err error) {
...
//	AND-mask              : 2 bytes
//	OR-mask               : 2 bytes
func (mb *client) MaskWriteRegister(slaveId uint8, address, andMask, orMask uint16) (results []byte, err error) {
	request := ProtocolDataUnit{
...
func (mb *client) ReadWriteMultipleRegisters(slaveId uint8, readAddress, readQuantity, writeAddress, writeQuantity uint16, value []byte) (results []byte, err error) {
...
func (mb *client) ReadFIFOQueue(slaveId uint8, address uint16) (results []byte, err error) {
	request := ProtocolDataUnit{
...
func (mb *client) send(slaveId uint8, request *ProtocolDataUnit) (response *ProtocolDataUnit, err error) {
	if slaveId > SlaveIdMax /*|| slaveId < SlaveIdMin*/ {
		err = fmt.Errorf("modbus: slaveId should be between '%v' and '%v'", SlaveIdMin, SlaveIdMax)
		return
	}
